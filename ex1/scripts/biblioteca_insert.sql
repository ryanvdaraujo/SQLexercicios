...
insert into emprestimo values(1,1,'2015-11-03','2015-11-18');
insert into emprestimo values(2,1,'2015-11-03','2015-11-18');
insert into emprestimo values(3,2,'2015-11-03','2015-11-18');
insert into emprestimo values(4,2,'2015-11-03','2015-11-18');
insert into emprestimo values(5,3,'2015-11-03','2015-11-18');
insert into emprestimo values(6,3,'2015-11-03','2015-11-18');
insert into emprestimo values(7,4,'2015-11-03','2015-11-18');
insert into emprestimo values(8,4,'2015-11-03','2015-11-18');
insert into emprestimo values(9,5,'2015-11-03','2015-11-18');
insert into emprestimo values(10,5,'2015-11-03','2015-11-18');
insert into emprestimo values(11,5,'2015-11-03','2015-11-18');
insert into emprestimo values(12,5,'2015-11-03','2015-11-18');
insert into emprestimo values(13,5,'2015-10-10','2015-10-25');
...
insert into devolucao values(1,curdate(),1,1);
insert into devolucao values(2,curdate(),3,1);
insert into devolucao values(3,curdate(),10,3);
insert into devolucao values(4,curdate(),9,5);
insert into devolucao values(5,curdate(),7,4);